...
CollaboRate aims to provide free tools and process that combine two powerful ideas - Work Breakdown and Visual Programming - to generate mass employement. It will help make available online intellectual work that involve small 'micro-tasks' of text comprehension (text less than 2000 characters). The online workers (collectively called the 'crowd') will answer questions based on these texts. The questions are asked by a 'Work Breakdown Wizard' tool. This wizard asks a series of questions to the worker. The initial questions are objective-type (i.e. the user needs to simply choose from one of the available choices already displayed on the screen). The choice made to answer the previous question, will determine the next question and choice asked to the user. Some text needs to be captured as well. In this way, workers slowly break down English text that are description of parts of software apps, into logic and text that is used to generate code as well as to create new text micro-tasks for the next level of the work breakdown.   

For commercial use, Natural Language Processing and supporting AI techniques will probably be needed to validate the inputs given by the crowd. The need for such technology can be reduced or even eliminated, by having a suitable review and reward process in place. As such AI techniques for validating the work done by the crowd is out of the scope of this Open Source project. This can be implemented by commercial entities called 'CrowdSourcing vendors' that will be organizations like IT Service companies. These companies will take work from customers and create the online text comprehension work opportunities. These vendors act like a broker between customers and the Crowd, and earn a percentage of profit in the process.
