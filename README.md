...
|Fair and accurate income for employees and the organization.|Work is given out and measured in tiny pieces called 'microtasks'. These microtasks are almost identical in size+complexity. Due to extremely fast project completion time, customer is charged based on actual work, rather than estimated work. Employees can earn as much as they can, without worrying about any limitations imposed on their salaries. They can also work as little as they need to, without anyone worrying about impact to the project.|   
