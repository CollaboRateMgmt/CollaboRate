...
Requirement problem statements break down into logic problem statements. The Collaborate tool helps to break down logic problem statements. When you break down logic problem statements, you also generate software program steps (pseudocode). A crowd member with no programming background may not even realize that he/she has created program steps!
